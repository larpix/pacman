...
QSPI Programming
Use fsbl built to configure board for QSPI flashing. Use XSCT tool in Vitis 2021.2:

exec program_flash -f <path-to-boot.bin> -fsbl <path-to-fsbl_flash.elf> -verify -flash_type qspi-x4-single
--------------------------------------------------------------
